 ...
 *
 * `ai-helper/skills/svg-animations/assets/character-wireframes.svg` holds a
...
const ASSET = join(root, 'ai-helper', 'skills', 'svg-animations', 'assets', 'character-wireframes.svg');
...
const ASSET_OUT = join(root, 'ai-helper', 'skills', 'svg-animations', 'assets', 'skeleton-cycles.json');
 ...
 * \`ai-helper/skills/svg-animations/assets/character-wireframes.svg\`: one
...
`, 'utf-8');
  ...
  console.log('wireframe-cycles: wrote the skeleton asset to ai-helper/skills/svg-animations/assets/skeleton-cycles.json');
