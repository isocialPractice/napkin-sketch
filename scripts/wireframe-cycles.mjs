 ...
 *
 * `ai-helper/skills/vector-animations/assets/character-wireframes.svg` holds a
...
const ASSET = join(root, 'ai-helper', 'skills', 'vector-animations', 'assets', 'character-wireframes.svg');
...
const ASSET_OUT = join(root, 'ai-helper', 'skills', 'vector-animations', 'assets', 'skeleton-cycles.json');
...
`, 'utf-8');
  ...
  console.log('wireframe-cycles: wrote the skeleton asset to ai-helper/skills/vector-animations/assets/skeleton-cycles.json');
